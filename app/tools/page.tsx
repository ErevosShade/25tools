...
function SearchIcon() {
  return (
    <svg
      className="w-4 h-4 text-[#6B6B6B] shrink-0"
      viewBox="0 0 20 20"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.5"
  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-10">
      <div className="flex flex-col md:flex-row gap-10">
        ...
        {/* ══ Sidebar ══════════════════════════════════════════ */}
        <aside
          className="w-full md:w-[240px] md:shrink-0"
                    ...
                    <li key={label} className="shrink-0 md:shrink">
                      <button
                        ...
                        className={cn(
                          ...
                          // Desktop: left border indicator
                          "md:border-l-2 md:rounded-none",
                          // Active vs inactive
                          active
                            ? [
                      ...
                      >
                        ...
                        <span
                          className={cn(
                            ...
                            active ? "text-[#6B6B6B]" : "text-[#9B9B9B]"
                          )}
                        >
                          {count}
                        </span>
        ...
        <div className="flex-1 min-w-0">
            ...
            {query && (
              <button
                ...
                className={cn(
                  ...
                  "text-[#6B6B6B] hover:text-[#0A0A0A] transition-colors duration-100",
          ...
          {filtered.length > 0 ? (
            <ul
              className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-3 list-none p-0 m-0"
            ...
            <div className="flex flex-col items-center justify-center py-24 gap-3 text-center border border-[#E5E5E5] rounded-[12px]">
              ...
              <div className="flex flex-col gap-1">
                <p className="text-[14px] font-[500] text-[#0A0A0A] m-0">
                  No tools found
                </p>
              ...
              {(query || activeCategory !== "All") && (
                <button
                  ...
                  className={cn(
                    "mt-1 h-8 px-4 rounded-full",
                    "border border-[#E5E5E5] bg-white",
                    "text-[13px] font-[500] text-[#0A0A0A]",
