      ...
      <div className="mx-auto max-w-3xl px-5 py-10 flex flex-col gap-8">
        ...
        <nav aria-label="Breadcrumb">
          <ol className="flex items-center gap-1.5 list-none p-0 m-0 flex-wrap">
            ...
            <li aria-hidden="true">
              <span className="text-[13px] text-[#D0D0D0] leading-none select-none">›</span>
            </li>
            <li>
              <Link
            ...
            <li aria-current="page">
              <span className="text-[13px] font-[400] text-[#0A0A0A] leading-none">
                {toolName}
              </span>
            </li>
          </ol>
                      ...
                      <li key={index} className="flex gap-4">
                        <div className="flex flex-col items-center">
                          <div className="w-6 h-6 rounded-full bg-[#0A0A0A] flex items-center justify-center shrink-0 mt-0.5">
                            <span className="text-[11px] font-[500] text-white leading-none tabular-nums">
                              {index + 1}
                            </span>
                          </div>
                          {!isLast && (
              ...
              {relatedTools.slice(0, 3).map((tool) => (
                <Link
                  ...
                  className={cn(
                    ...
                    "focus-visible:ring-offset-2 focus-visible:rounded-[10px]"
                  )}
                >
